...
def main():
    ...
    generate_silo(orifice_diameter, 1.09*particle_diameter, 120.2*particle_diameter, 1.1*particle_diameter, 200.0*particle_diameter)
    generate_lid(orifice_diameter, 1.09*particle_diameter)
    generate_insertionsface(110*particle_diameter, 1.0*particle_diameter, 190.0*particle_diameter)
